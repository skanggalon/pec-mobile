...
import 'package:pec_mobile/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
  final String npm = '2306224410'; // NPM
  final String name = 'Muhammad Zaid Ats Tsabit'; // Nama
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Pacil Electronic Center" dengan teks putih dan tebal.
        title: const Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Welcome to Pacil Electronic Center',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
